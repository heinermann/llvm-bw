...
@someGlobal = global i32 5, align 4

; Function Attrs: noinline nounwind optnone uwtable
define void @_Z5Sleepi(i32) #0 {
...
define i32 @main() #1 {
  ...
  store i16 1, i16* inttoptr (i64 5763548 to i16*), align 2
  br label %2

; <label>:2:                                      ; preds = %0, %2
  store i16 0, i16* inttoptr (i64 6621600 to i16*), align 2
  call void @_Z5yieldv()
  br label %2
                                                  ; No predecessors!
